...
using bot_for_pratap.Dialogs.Main;

namespace bot_for_pratap
{
    /// <summary>
    ...
    public class Bot : IBot
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="bot_for_pratap"/> class.
        /// </summary>
        ...
        public Bot(BotServices botServices, ConversationState conversationState, UserState userState, IBotTelemetryClient telemetryClient)
        {
            ...
            _dialogs = new DialogSet(_conversationState.CreateProperty<DialogState>(nameof(bot_for_pratap)));
